package jianqiang.com.providerbhost.hook;
...
import jianqiang.com.providerbhost.RefInvoke;
...
public final class BaseDexClassLoaderHookHelper {
    ...
    public static void patchClassLoader(ClassLoader cl, File apkFile, File optDexFile)
        ...
        Class[] p1 = {DexFile.class};
        Object[] v1 = {DexFile.loadDex(apkFile.getCanonicalPath(), optDexFile.getAbsolutePath(), 0)};
